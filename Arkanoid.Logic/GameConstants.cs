namespace Arkanoid.Logic
{
    ...
    public static class GameConstants
    {
        ...
        public const int InitialBallY = 400;
        /// <summary> Размер (диаметр) мяча. </summary>
        public const int BallSize = 20;

        /// <summary> Начальная позиция ракетки по оси X. </summary>
        public const int InitialPaddleX = 325;
        /// <summary> Начальная позиция ракетки по оси Y. </summary>
        public const int InitialPaddleY = 540;
        /// <summary> Начальная ширина ракетки. </summary>
        public const int InitialPaddleWidth = 150;
        /// <summary> Начальная высота ракетки. </summary>
        public const int InitialPaddleHeight = 20;

        /// <summary> Размер выпадающего бонуса. </summary>
        public const int BoosterSize = 20;
    }
}